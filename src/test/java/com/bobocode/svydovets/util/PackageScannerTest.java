...
public class PackageScannerTest {
    ...
    void testScanAllBeansByConfigClass() {
        Set<Class<?>> result = packageScanner.findAllBeanByBaseClass(BeanConfigBase.class, BeanConfigPostConstruct.class);
    ...
    void testFindAllBeanByBaseClass() {
        Set<Class<?>> result = packageScanner.findAllBeanByBaseClass(BeanConfigBase.class);
    ...
    void testFindAllBeanByBaseClassOuterPackage() {
        Set<Class<?>> result = packageScanner.findAllBeanByBaseClass(BeanConfigForSomeBeans.class);
    ...
    void testFindAllBeanByBaseClassShouldReturnEmptySet() {
        Set<Class<?>> result = packageScanner.findAllBeanByBaseClass(NonAnnotatedClass.class);
    ...
    void testFindAllBeanByBaseConfigWithOtherClasses() {
        Set<Class<?>> result = packageScanner.findAllBeanByBaseClass(BeanConfigBase.class, SomeBean.class,
